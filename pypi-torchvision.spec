...
Source0  : https://github.com/pytorch/vision/archive/v0.22.0/vision-0.22.0.tar.gz
...
%prep
%setup -q -n vision-0.22.0
cd %{_builddir}/vision-0.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746132385
